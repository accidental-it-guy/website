...
const theme = {
  background: 'rgb(157, 123, 144)',
  foreground: 'rgb(189, 252, 201)',
  foregroundMuted: 'rgb(255, 199, 199)',
  linkBackground: 'rgb(225, 152, 152)',
  linkBackgroundHover: 'rgb(121, 129, 147)',
  linkOutline: 'rgb(189, 252, 201)',
  linkOutlineHover: 'rgb(233, 201, 221)',
  linkText: 'rgb(111, 121, 144)',
  linkTextHover: 'rgb(189, 252, 201)',
};
